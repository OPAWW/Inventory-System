...
class InventoryApp(tk.Tk):
    ...
    def view_add(self):
        ...
        self.two_panel_layout("Add Product", self.add_form)
    ...
    def view_search(self):
        ...
        self.two_panel_layout("Search Product", self.search_form)
    ...
    def view_update(self):
        ...
        self.two_panel_layout("Update Product", self.update_form)
    ...
    def view_delete(self):
        ...
        self.two_panel_layout("Delete Product", self.delete_form)

    # =====================================================
    # TWO PANEL LAYOUT
    # =====================================================
    def two_panel_layout(self, title, form_function):
        ...
        def update_product():
            ...
            for p in data:
                ...
                if p["item_no"] == target:
                    ...
                    p["category"] = entries["New Category"].get()
    ...
    def delete_form(self, frame):
        ...
        tk.Label(
            frame,
            text="Item Number or Product Name",
            font=self.header_font,
            bg=self.CARD
        ).pack(anchor="w")
